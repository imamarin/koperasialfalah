                                        ...
                                        @foreach ($anggota as $key => $item)
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="/users/anggota/delete/{{ $item->id }}"
                                            ...
                                            <div class="modal modal-lg fade" id="editModal{{ $item->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-primary text-white">
                                                            <h5 class="modal-title text-white">Ubah Data Anggota</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                        </div>
                                                        <form action="/users/anggota/edit/{{ $item->id }}"
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit"
                                                                    class="btn btn-primary btn-sm  px-2">Simpan Perubahan</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                        ...
                        <div class="modal modal-lg fade" id="primaryModal" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/users/anggota/create" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6">
